...
def test_eliminarRepetidos_1():
    assert Laboratorio5.eliminarSegundaRepeticion( [12, 78, 12, 0, 5.2, "abc", 0, 12, 5.2, 12] ) == [12, 78, 12, 0, 5.2, "abc", 0, 5.2]
    
def test_eliminarRepetidos_2():
    assert Laboratorio5.eliminarSegundaRepeticion( [12, 5.2, 12] ) == [12, 5.2, 12]
